...
public class Solution {
    ...
    *A method which checks if there is an overlapping section
    *@param row
    *the Y coordinate of the light being checked
    *@param collumn
    *the X coordinate of the light being checked
    *@return
    *a boolean representation of if the light is on
    */
    public boolean get(int row, int collumn){
