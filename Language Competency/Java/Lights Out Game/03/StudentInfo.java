 ...
 * off the Outline of Vince Marcel, University of Ottawa
*/
...
public class StudentInfo {
    ...
    */
    ...
    public static void display() {
        ...
        System.out.println("************************************************************");
        System.out.println("*   Aiden Stevenson Bradwell                               *");
        System.out.println("*   300064655                                              *");
        System.out.println("*   abrad060@uottawa.ca                                    *");
        System.out.println("*                                                          *");
        System.out.println("************************************************************");
        System.out.println();
